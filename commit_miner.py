...
def getTimeCommits(repo_dir_absolute_path):
    time_commit_dict = {}
...
def extractCommits(repo, branchName):
  ...
  commit_time_dict = getTimeCommits(repo_dir_absolute_path)
  ...
  for commit_ in all_commits: 
    ...
    tup_ = (repo, commit_hash, str_time_commit, add_loc, del_loc, tot_loc, author_exp, author_recent_exp, secu_flag) 
    # print tup_
...
if __name__=='__main__':
    ...
    # all_proj_df.to_csv(secu_out_csv_fil, header=['REPO','HASH','TIME', 'ADD_LOC', 'DEL_LOC', 'TOT_LOC', 'DEV_EXP', 'DEV_RECENT', 'SECU_FLAG'], index=False, encoding='utf-8') 
